...
class AuthService {
  public async Login(payload: PickLogin): Promise<TResponse<AuthSessionResponse>> {
  ...
  public async Register(payload: PickRegister): Promise<TResponse<SafeAuthUser>> {
  ...
  public async RefreshToken(payload: PickRefreshToken): Promise<TResponse<AuthSessionResponse>> {
  ...
  public async SendMagicLink(payload: PickSendMagicLink): Promise<TResponse<{ email: string }>> {
  ...
  public async SendOtp(payload: PickSendOtp): Promise<TResponse<{ sentTo: string }>> {
  ...
  public async VerifyOtp(payload: PickVerifyOtp): Promise<TResponse<AuthSessionResponse>> {
