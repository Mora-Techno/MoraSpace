...
class DepartmentService {
  ...
  ): Promise<TResponse<IDepartment[]>> {
    const res = await GetResponse<IDepartment[]>(
      withQuery(DEPARTMENT_ENDPOINTS.LIST, query),
    );
  ...
  public async CreateDepartment(
    payload: PickCreateDepartment,
  ): Promise<TResponse<IDepartment>> {
    const res = await PostResponse<IDepartment>(
  ...
  public async UpdateDepartment(
    ...
    const res = await PatchResponse<IDepartment>(
  ...
  public async DeleteDepartment(id: string): Promise<TResponse<IDepartment>> {
    const res = await DeleteResponse<IDepartment>(
