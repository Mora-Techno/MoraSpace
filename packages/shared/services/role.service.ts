...
import type { IRole, PickCreateRole, PickUpdateRole, PickUpdateRolePermissions } from "../types/role.types";
...
class RoleService {
  ...
  public async UpdateRolePermissions(id: string, payload: PickUpdateRolePermissions): Promise<TResponse<IRole>> {
