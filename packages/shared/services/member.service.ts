...
import type { ICompanyMember, PickUpdateCompanyMember, PickUpdateMemberProfile, PickUpdateMemberContacts } from "../types/member.types";
...
class MemberService {
  ...
  public async UpdateMember(id: string, payload: PickUpdateCompanyMember): Promise<TResponse<ICompanyMember>> {
  ...
  public async UpdateProfile(id: string, payload: PickUpdateMemberProfile): Promise<TResponse<any>> {
  ...
  public async UpdateContacts(id: string, payload: PickUpdateMemberContacts): Promise<TResponse<any>> {
