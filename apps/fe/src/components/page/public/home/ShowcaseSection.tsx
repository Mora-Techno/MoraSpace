...
const ARTICLES = [
  {
    ...
    excerpt: 'Pelajari teknik prioritas dan time-blocking untuk menyelesaikan tugas tanpa stres.',
    date: '8 Jun 2026',
  ...
  },
  {
    ...
    excerpt: 'Simpan ide dan referensi dengan sistem tagging yang mudah diakses kapan saja.',
    date: '5 Jun 2026',
  ...
  },
  {
    ...
    excerpt: 'Soundtrack Joe Hisaishi dan ambient music yang terbukti meningkatkan konsentrasi.',
    date: '1 Jun 2026',
      ...
      <div className="mx-auto max-w-5xl">
        <div className="mb-10 flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
          <div>
            ...
            <p className="mt-2 text-zinc-400">
              Insight produktivitas dan tips menggunakan MoraSpace.
            </p>
          </div>
          <Link
            href="/login"
        ...
        <div ref={ref} className="grid gap-6 md:grid-cols-3">
          {ARTICLES.map((article) => (
            ...
            >
              <div className={`flex h-44 items-end bg-gradient-to-br ${article.gradient} p-5`}>
