...
export const CreateTaskDto = t.Object({
  ...
  priorityId: t.Optional(t.String({ format: 'uuid', description: 'ID prioritas tugas' })),
...
export const AssignTaskDto = t.Object({
  assigneeIds: t.Array(t.String({ format: 'uuid' }), { description: 'Daftar ID assignee' }),
});
...
export const CreateTaskChecklistDto = t.Object({
  ...
  items: t.Optional(t.Array(t.String(), { description: 'Daftar item checklist' })),
});
