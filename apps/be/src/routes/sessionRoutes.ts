...
class SessionRouter {
  ...
  private routes() {
    ...
    this.sessionRouter.get('/:id', (c: AppContext) => SessionController.getById(c), {
    ...
    this.sessionRouter.delete('/:id', (c: AppContext) => SessionController.deleteSessionById(c), {
      beforeHandle: [verifyToken().beforeHandle],
      params: SessionParamsDto,
      detail: {
    ...
    this.sessionRouter.delete('/', (c: AppContext) => SessionController.deleteSession(c), {
      beforeHandle: [verifyToken().beforeHandle],
      detail: {
