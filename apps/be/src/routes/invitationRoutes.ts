...
class InvitationRouter {
  ...
  private routes() {
    this.invitationRouter.get('/', (c: AppContext) => InvitationController.list(c), {
    ...
    this.invitationRouter.post('/', (c: AppContext) => InvitationController.create(c), {
    ...
    this.invitationRouter.post('/accept', (c: AppContext) => InvitationController.accept(c), {
    ...
    this.invitationRouter.post('/reject', (c: AppContext) => InvitationController.reject(c), {
    ...
    this.invitationRouter.delete('/:id', (c: AppContext) => InvitationController.remove(c), {
