...
class TaskRouter {
  ...
  private routes() {
    ...
    this.taskRouter.post('/:id/assign', (c: AppContext) => TaskController.assign(c), {
      params: TaskParamsDto,
      body: AssignTaskDto,
      beforeHandle: [verifyToken().beforeHandle],
      detail: {
    ...
    this.taskRouter.post('/:id/status', (c: AppContext) => TaskController.updateStatus(c), {
      params: TaskParamsDto,
    ...
    this.taskRouter.post('/:id/comment', (c: AppContext) => TaskController.addComment(c), {
      params: TaskParamsDto,
    ...
    this.taskRouter.post('/:id/checklist', (c: AppContext) => TaskController.createChecklist(c), {
      params: TaskParamsDto,
    ...
    this.taskRouter.post('/:id/attachment', (c: AppContext) => TaskController.addAttachment(c), {
      params: TaskParamsDto,
    ...
    this.taskRouter.get('/:id/activity', (c: AppContext) => TaskController.listActivities(c), {
      params: TaskParamsDto,
      beforeHandle: [verifyToken().beforeHandle],
      detail: {
