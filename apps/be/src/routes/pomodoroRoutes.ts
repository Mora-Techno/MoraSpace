...
class PomodoroRouter {
  ...
  private routes() {
    this.pomodoroRouter.post('/start', (c: AppContext) => PomodoroController.start(c), {
    ...
    this.pomodoroRouter.post('/pause', (c: AppContext) => PomodoroController.pause(c), {
      beforeHandle: [verifyToken().beforeHandle],
      detail: {
    ...
    this.pomodoroRouter.post('/resume', (c: AppContext) => PomodoroController.resume(c), {
      beforeHandle: [verifyToken().beforeHandle],
      detail: {
    ...
    this.pomodoroRouter.post('/stop', (c: AppContext) => PomodoroController.stop(c), {
    ...
    this.pomodoroRouter.get('/today', (c: AppContext) => PomodoroController.getToday(c), {
      beforeHandle: [verifyToken().beforeHandle],
      detail: {
    ...
    this.pomodoroRouter.get('/statistics', (c: AppContext) => PomodoroController.getStatistics(c), {
      beforeHandle: [verifyToken().beforeHandle],
      detail: {
