...
class MemberRouter {
  ...
  private routes() {
    ...
    this.memberRouter.get('/:id', (c: AppContext) => MemberController.getById(c), {
    ...
    this.memberRouter.patch('/:id', (c: AppContext) => MemberController.update(c), {
      params: MemberParamsDto,
    ...
    this.memberRouter.delete('/:id', (c: AppContext) => MemberController.remove(c), {
      params: MemberParamsDto,
      beforeHandle: [verifyToken().beforeHandle],
      detail: {
    ...
    this.memberRouter.get('/:id/profile', (c: AppContext) => MemberController.getProfile(c), {
      params: MemberParamsDto,
      beforeHandle: [verifyToken().beforeHandle],
      detail: {
    ...
    this.memberRouter.patch('/:id/profile', (c: AppContext) => MemberController.updateProfile(c), {
      params: MemberParamsDto,
    ...
    this.memberRouter.get('/:id/contact', (c: AppContext) => MemberController.getContacts(c), {
      params: MemberParamsDto,
      beforeHandle: [verifyToken().beforeHandle],
      detail: {
    ...
    this.memberRouter.patch('/:id/contact', (c: AppContext) => MemberController.updateContacts(c), {
      params: MemberParamsDto,
